"""
Anisotropic s+id superconductor theory registration and terminal description.
...
THEORY_SPEC = TheorySpec(
    name="Anisotropic superconductor",
    aliases=("s+id superconductor", "Multicomponent superconductor", "Multi-component superconductor", "Multicomponent GL", "Multi-component GL", "Multicomponent Ginzburg-Landau", "Multi-component Ginzburg-Landau"),
    import_path="soliton_solver.theories.anisotropic_superconductor",
    description="Multi-component anisotropic s+id superconductor, simulating multi-component vortices.",
    version="1.0"
)
