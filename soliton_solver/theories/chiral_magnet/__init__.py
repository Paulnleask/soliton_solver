"""
Chiral magnet theory package registration and user-facing theory description.

This module defines the registry metadata for the chiral magnet model.
...
def _print_metadata() -> None:
    """
    Print the core registry metadata for the chiral magnet theory.
...
def _print_submodules() -> None:
    """
    Print the main chiral magnet theory submodules available to the user.
...
def _print_parameter_information() -> None:
    """
    Print detailed parameter information for the chiral magnet theory.
...
def _print_notes() -> None:
    """
    Print a short high-level summary of the chiral magnet model contents.
...
def _print_instructions() -> None:
    """
    Print additional usage instructions for the chiral magnet theory.
...
def describe() -> None:
    """
    Print a structured terminal description of the chiral magnet theory.
    ...
    -------
    None
        This function prints the chiral magnet theory description to the terminal.
