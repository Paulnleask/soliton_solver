# =========================
# soliton_solver/theories/chiral_magnet/io.py
# =========================
"""
...
def output_data_bundle(
    ...
    arrays = {"grid": h_grid, "Field": h_Field, "EnergyDensity": h_EnergyDensity, "BaryonDensity": h_BaryonDensity, "MagneticChargeDensity": h_MagneticChargeDensity}
