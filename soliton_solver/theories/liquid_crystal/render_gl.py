# =========================
# soliton_solver/theories/liquid_crystal/render_gl.py
# =========================
"""
...
class GLRenderer:
    ...
    def bind_sim(self, sim):
        ...
        - Reads initial skyrmion_rotation from sim.p_f_h[12] if present.
        """
        self._sim = sim
        try:
    ...
    def _set_topological_number(self, n: float):
        ...
        - Writes:
            sim.p_f_h[11] = n  (skyrmion_number)
        ...
        sim.p_f_h[11] = float(n)  # skyrmion_number
