...
draw_panel(ax11, xGrid, yGrid, EnergyDensity, r"$\mathcal{E}(x,y)$", xLength, yLength, xlim=(xMin,xMax), ylim=(yMin,yMax))
ax11.set_xlabel(r"$x$")
ax11.set_ylabel(r"$y$")

# Magnetic charge density
ax12 = fig1.add_subplot(gs[0, 1])
draw_panel(ax12, xGrid, yGrid, ChargeDensity, r"$\mathcal{Q}(x,y)$", xLength, yLength, xlim=(xMin,xMax), ylim=(yMin,yMax),cmap="bone")
ax12.set_xlabel(r"$x$")
ax12.set_ylabel(r"$y$")
