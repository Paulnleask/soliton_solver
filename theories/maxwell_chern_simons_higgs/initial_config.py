# =========================
# soliton_solver/theories/maxwell_chern_simons_higgs/initial_config.py
# =========================
"""
Initial condition / ansatz CUDA kernels for the maxwell_chern_simons_higgs simulation.
